                  ...
                  <>
                    <li className="d-flex flex-row">
                      <Link href="/activity" className={`${style['nav-item']}`}>
                        <img src="/icons/activity.svg" className="me-2" width="20px" alt="Aktivitas icon" />Cari Aktivitas
                      </Link>
                    </li>
                    <li className="d-flex flex-row">
                      <Link href="/my-agenda" className={`${style['nav-item']}`}>
                        <img src="/icons/agenda.svg" className="me-2" width="20px" alt="Agenda icon" /> Agenda Saya
                      </Link>
                    </li>

                    <li className="d-flex flex-row">
                      <Link href="/favorite" className={`${style['nav-item']}`}>
                        <img src="/icons/favorite.svg" className="me-2" width="20px" alt="Agenda icon" /> Favorit
                      </Link>
                    </li>
                  </>
                ) : null
        ...
        <div className="d-flex align-items-center justify-content-end">
          {
            ...
            ) : <Link href="/login" className="btn btn-outline fc-tiffany-04 fs-14px">Login</Link>
          }
